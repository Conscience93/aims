    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="tab-all" data-toggle="tab" href="#all" role="tab" aria-controls="all" aria-selected="false">
                All (<?php
                        $sqlTotalInvoice = "SELECT id FROM `aims_inventory_p.o` WHERE status = 'APPROVE'";
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="tab-outstanding" data-toggle="tab" href="#outstanding" role="tab" aria-controls="outstanding" aria-selected="false">
                Outstanding (<?php
                        $sqlTotalOutstanding = "SELECT id FROM `aims_inventory_p.o` WHERE status = 'OUTSTANDING' AND approval = 'APPROVE'";
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="tab-unpaid" data-toggle="tab" href="#unpaid" role="tab" aria-controls="unpaid" aria-selected="false">
                Unpaid (<?php
                        $sqlTotaUnpaid = "SELECT id FROM `aims_inventory_p.o` WHERE status = 'UNPAID' AND approval = 'APPROVE'";
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="tab-paid" data-toggle="tab" href="#paid" role="tab" aria-controls="paid" aria-selected="false">
                Paid (<?php
                        $sqlTotalPaid = "SELECT id FROM `aims_inventory_p.o` WHERE status = 'PAID' AND approval = 'APPROVE'";
        ...
        <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="tab-all">
            <div class="card shadow rounded">
                <div class="card-header" style="background:white;">
                    <div class="row">
                        <div class="col-6">
                            <h2>All Purchased Order</h2>
                        </div>
                        <div class="col-6">
                            <div class="float-right"> 
                                <a href="./addInvoice" class="btn btn-info">Add Purchase Order</a>  
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body" style="max-height: 76vh; overflow-y: scroll;">
                    <table id="table_all" class="striped-table">
                        ...
                        $sqlTotalInvoice = "SELECT id FROM `aims_inventory_p.o` WHERE approval = 'APPROVE'";
        ...
        <div class="tab-pane fade show" id="outstanding" role="tabpanel" aria-labelledby="tab-outstanding">
            <div class="card shadow rounded">
                <div class="card-header" style="background:white;">
                    <div class="row">
                        <div class="col-6">
                            <h2>Outstanding Purchased Order</h2>
                        </div>
                        <div class="col-6">
                            <div class="float-right"> 
                                <a href="./addInvoice" class="btn btn-info">Add Purchase Order</a>  
                ...
                <div class="card-body" style="max-height: 76vh; overflow-y: scroll;">
                    <table id="table_outstanding" class="striped-table">
                        ...
                        // Query invoices from aims_all_asset_Invoice table with pictures from aims_all_asset_picture table
                        $sqlTotalInvoice = "SELECT id FROM `aims_inventory_p.o` WHERE status = 'OUTSTANDING' AND approval = 'APPROVE'";
                        $queryInvoice = mysqli_query($con, $sqlTotalInvoice);
            ...
            <div class="card shadow rounded">
                ...
                <div class="card-body" style="max-height: 76vh; overflow-y: scroll;">
                    <table id="table_unpaid" class="striped-table">
                        ...
                        // Query invoices from aims_all_asset_Invoice table with pictures from aims_all_asset_picture table
                        $sqlTotalInvoice = "SELECT id FROM `aims_inventory_p.o` WHERE status = 'UNPAID' AND approval = 'APPROVE'";
                        $queryInvoice = mysqli_query($con, $sqlTotalInvoice);
            ...
            <div class="card shadow rounded">
                ...
                <div class="card-body" style="max-height: 76vh; overflow-y: scroll;">
                    <table id="table_paid" class="striped-table">
                        ...
                        // Query invoices from aims_all_asset_Invoice table with pictures from aims_all_asset_picture table
                        $sqlTotalInvoice = "SELECT id FROM `aims_inventory_p.o` WHERE status = 'PAID' AND approval = 'APPROVE'";
                        $queryInvoice = mysqli_query($con, $sqlTotalInvoice);
...
<script>
    ...
    function deleteInvoice(id) {
        $.ajax({
        url: "./module/inventory/p.o/deleteInvoice_action.php", // Update the URL to your PHP script
