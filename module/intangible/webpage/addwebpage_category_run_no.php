...
$duplicateCheckQuery = "SELECT id FROM aims_webpage_category_run_no WHERE display_name = '$display_name' AND category = '$category' AND prefix = '$prefix'";
...
$sql = "INSERT INTO aims_webpage_category_run_no 
