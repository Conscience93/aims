        ...
        <main>
            ...
            <table class="customer-table">
                ...
                <tr>
                    ...
                    <td class="table-header"><strong>Expected Disposed Date: </strong><?php echo $row['expected_date'];?></td>
                    <td class="table-header"><strong>Value : </strong>RM<?php echo $row['value'];?></td>
                </tr>
                <tr>
                    <td colspan="3" class="table-header"><strong>Reason: </strong><?php echo $row['reason'];?></td>
                </tr>
                <!-- Disposed to Specification Section -->
                <tr>
                    <th colspan="3" class="table-header">Disposed To Details</th>
                </tr>
                <tr>
                    <td class="table-header"><strong>Location: </strong><?php echo $row['company'];?></td>
                    <td class="table-header"><strong>Email: </strong><?php echo $row['email'];?></td>
                    <td class="table-header"><strong>Company Phone No.: </strong><?php echo $row['phone_no'];?></td>
                </tr>
                <tr>
                    <td colspan="2" class="table-header"><strong>Contact Person: </strong><?php echo $row['pic'];?></td>
                    <td class="table-header"><strong>Contact No: </strong><?php echo $row['pic_phone_no'];?></td>
                </tr>
                <tr>
