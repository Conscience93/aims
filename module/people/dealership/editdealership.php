...
$sql = "SELECT * FROM aims_people_dealership where id ='".$_GET['id']."'";
...
<div class="main">
    <form action=".\module\people\dealership\editdealership_action.php" method="POST">
    <div class="card shadow rounded">
        <div class="card-header" style="background:white;">
        <div class="row">
                    <div class="col-6">
                        <h4>Edit Dealership Details</h4>
                    </div>
                    <div class="col-6">
        ...
        success: function(response){
            ...
            if(response.trim()=="true"){
                Swal.fire({
                    icon: 'success',
                    title: 'Success',
                    text: 'Dealership edited successfully!',
                    showConfirmButton: false,
                    timer: 1500
                }).then(function() {
                    window.location.href = './dealership?id=<?php echo $row["id"];?>';
                });
            }else{
                Swal.fire({
                    icon: 'error',
