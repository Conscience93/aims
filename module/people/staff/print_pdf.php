    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <table class="customer-table">
                <tr>
                    <th colspan="3" class="table-header">Staff <?php echo $row['id'];?> Details</th>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="table-header"><strong>Company: </strong><?php echo $row['branch'];?></td>
                    <td colspan="2" class="table-header"><strong>Department: </strong><?php echo $row['department'];?></td>
                </tr>
                <tr>
