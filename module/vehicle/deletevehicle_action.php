...
$sql_asset = "SELECT * FROM aims_vehicle WHERE id = '$id'";
...
$target_roadtax_file = "../../" . $row['roadtax'];
$target_insurance_file = "../../" . $row['insurance'];
...
if (!empty($target_roadtax_file)) {
    unlink($target_roadtax_file);
}
if (!empty($target_insurance_file)) {
    unlink($target_insurance_file);
}


// Creating File Upload Directory
$target_directory_invoice = "../../include/upload/invoice/asset/" . $row['asset_tag'];
$target_directory_document = "../../include/upload/document/asset/" . $row['asset_tag'];
$target_directory_picture = "../../include/upload/picture/asset/" . $row['asset_tag'];
$target_directory_warranty = "../../include/upload/warranty/asset/" . $row['asset_tag'];
$target_directory_roadtax = "../../include/upload/roadtax/asset/" . $row['asset_tag'];
$target_directory_insurance = "../../include/upload/insurance/asset/" . $row['asset_tag'];
...
rmdir($target_directory_roadtax);
rmdir($target_directory_insurance);

// Delete records from aims_asset
$sql_asset_delete = "DELETE FROM aims_vehicle WHERE id = '$id'";
