...
$sql = "SELECT name FROM aims_asset WHERE name LIKE '%$searchTerm%'
        UNION
        SELECT name FROM aims_computer WHERE name LIKE '%$searchTerm%'
        UNION
        SELECT name FROM aims_electronics WHERE name LIKE '%$searchTerm%'";
