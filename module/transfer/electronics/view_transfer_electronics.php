...
$sql = "SELECT * FROM aims_transfer_electronics where id ='".$_GET['id']."'";
$result = mysqli_query($con, $sql);
$row = mysqli_fetch_assoc($result);

$sql2 = "SELECT * FROM aims_electronics WHERE asset_tag = '" . $row['asset_tag'] . "'";
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                ...
                                <a class="btn btn-primary" href='./module/transfer/electronics/print.php?id=<?php echo $row['id'];?>' target="_blank" title="Print">Print</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card shadow rounded">
            ...
            <div class="card-body">
                <table id="table_transfer" class="striped-table">
                    ...
                    <?php
                    $sqlTransfer = "SELECT * FROM aims_transfer_electronics WHERE asset_tag ='" . $row['asset_tag'] . "'";
                    ...
                    while ($rowTransfer = mysqli_fetch_assoc($queryTransfer)) {
                        ...
                        $sql4 = "SELECT * FROM aims_transfer_electronics where name ='" . $rowTransfer['name'] . "'";
