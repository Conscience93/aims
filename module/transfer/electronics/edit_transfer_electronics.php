...
<div class="main">
    <form action=".\module\transfer\electronics\editelectronics_transfer_action.php" method="POST">
        ...
        success: function(response){
            ...
            if(response.trim()=="true"){
                ...
                Swal.fire({
                    ...
                    window.location.href = './edit_transfer_electronics?id=<?php echo $row["id"];?>';
                });
            }
        },
        cache: false,
