                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                ...
                                <a class="btn btn-primary" href='./module/transfer/asset/print.php?id=<?php echo $row['id'];?>' target="_blank" title="Print">Print</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class = "row">
                        <div class="col-7">
                            ...
                            <div class="row">
                                ...
                                <span class="col-5" id="branch" name="branch"><?php echo $row['transfer_branch'];?></span>
                            </div>
                            <div class="row">
                                <label class="col-3" for="department"><b>Department: </b></label>
                                <span class="col-5" id="department" name="department"><?php echo $row['transfer_department'];?></span>
                            </div>
                            <div class="row">
                                <label class="col-3" for="location"><b>Location: </b></label>
                                <span class="col-5" id="location" name="location"><?php echo $row['transfer_location'];?></span>
                            </div>
