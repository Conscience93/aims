...
<div class="main">
    <form action="./module/transfer/asset/addasset_transfer_action.php" method="POST" id="transferForm">
                ...
                <div class = "row">
                     ...
                     <div class="col-3">
                        <div class="form-group">
                            <label for="name">Search Fixed Asset</label>
                ...
                <div class = "row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <span id="branch" name="branch" placeholder="" class="form-control"></span>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label for="department">Department</label>
                            <span id="department" name="department" placeholder="" class="form-control"></span>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label for="location">Location</label>
                            <span id ="location" name="location" placeholder="" class="form-control"></span>
                        </div>
                    </div>
                </div>
...
function searchAsset() {
    ...
    if (input.trim() !== '') {
        ...
        xhr.open('GET', 'module/transfer/asset/smart_search.php?name=' + input, true);
        xhr.send();
    } else {
