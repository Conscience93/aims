...
<div class="main">
    <form action=".\module\transfer\computer\editcomputer_transfer_action.php" method="POST" id="transferForm">
        ...
        success: function(response){
            ...
            if(response.trim()=="true"){
                ...
                Swal.fire({
                    ...
                    window.location.href = './edit_transfer_computer?id=<?php echo $row["id"];?>';
                });
            }
        },
        cache: false,
