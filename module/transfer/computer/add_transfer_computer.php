...
<div class="main">
    <form action="./module/transfer/computer/addcomputer_transfer_action.php" method="POST" id="transferForm">
                ...
                <div class = "row">
                     ...
                     <div class="col-3">
                        <div class="form-group">
                            <label for="name">Search Computer</label>
...
function searchAsset() {
    ...
    if (input.trim() !== '') {
        ...
        xhr.open('GET', 'module/transfer/computer/smart_search.php?name=' + input, true);
        xhr.send();
    } else {
