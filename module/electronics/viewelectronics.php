                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                ...
                                <a class="btn btn-primary" href='./module/electronics/print.php?id=<?php echo $row['id'];?>' target="_blank" title="Print">Print</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-7">
                                ...
                                <div class="row">
                                    ...
                                    <label class="col-2" for="model_no"><b>Model_no: </b></label>
                                    <span class="col-3" id="model_no" name="model_no"><?php echo $row['model_no'];?></span>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <span class="col-8" id="remark" name="remark"><?php echo $row['remark']; ?></span>
                                </div>
                                <div class="row">
                                    <div class="col-7">
