...
$duplicateCheckQuery = "SELECT id FROM aims_electronics_category_run_no WHERE display_name = '$display_name' AND category = '$category' AND prefix = '$prefix'";
...
// Insert data into the aims_electronics_category_run_no with fixed next_no and digit_no
$sql = "INSERT INTO aims_electronics_category_run_no 
