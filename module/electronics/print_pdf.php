...
<head>
    <meta charset="UTF-8">
    <title>Print Electronics Info</title>
    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <table class="customer-table">
                <tr>
                    <th colspan="3" class="table-header">Electronic <?php echo $row['asset_tag'];?> Details</th>
                </tr>
                <tr>
                    <td colspan="1" class="table-header"><strong>Electronic: </strong><?php echo $row['name'];?></td>
                ...
                <tr>
                    <td class="table-header"><strong>Model Number: </strong><?php echo $row['model_no'];?></td>
