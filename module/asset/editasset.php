...
<div class="main">
    <form action=".\module\asset\editasset_action.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input list="assetCategoryList" name="category" value="<?php echo $row['category'];?>" id="category" class="form-control">
                                <datalist id="assetCategoryList">
                                    <?php 
                                    $sql_categories = "SELECT * FROM aims_asset_category_run_no";
            ...
            success: function(response){
                ...
                if(response.trim()=="true"){
                    ...
                    Swal.fire({
                        ...
                        window.location.href = './editasset?id=<?php echo $row["id"];?>';
                    });
                }
            },
            cache: false,
...
function deleteFile(id, fileType) {
    $.ajax({
        url: "./module/asset/deletefile_action.php", // Update the URL to your PHP script
        ...
        success: function(response) {
            ...
            Swal.fire({
                ...
                window.location.href = './editasset?id=' + id;
            });
...
function deleteExistingPicture(input, id, view, asset_id) {
    $.ajax({
        url: "./module/asset/deletepicture_action.php",
        type: "POST",
        ...
        success: function(response) {
            Swal.fire({
                ...
                window.location.href = './editasset?id=' + asset_id;
            });
        },
        error: function(xhr, status, error) {
            Swal.fire({
