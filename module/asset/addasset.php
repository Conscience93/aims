...
<div class="main">
    <form action=".\module\asset\addasset_action.php" method="POST" enctype="multipart/form-data">
    <div class="card shadow rounded">
        <div class="card-header" style="background:white;">
            <div class="row">
                <div class="col-6">
                    <h4>Add Asset Information</h4>
                </div>
                <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="dropdown">
                            ...
                            <div id="myDropdown" class="dropdown-content" style="display: none;">
                                <?php 
                                $sql_smartSearchs = "SELECT * FROM aims_asset";
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <datalist id="assetCategoryList">
                                ...
                                <?php 
                                $sql_categories = "SELECT category, display_name FROM aims_asset_category_run_no";
...
function autoFillPrefix() {
    ...
    if (categoryInput.value.length >= 2) {
        prefixInput.value = 'A' + categoryInput.value.substring(0, 2).toUpperCase();
    } else if (categoryInput.value.length === 1) {
        prefixInput.value = 'A' + categoryInput.value.toUpperCase() + 'X';
...
$(document).ready(function () {
    ...
    $('#addAssetCategoryButton').click(function() {
        ...
        if (!/^A/.test(prefixValue)) {
            ...
            $.ajax({
                url: './module/asset/addasset_category_run_no.php',
                type: 'POST',
                data: formData,
                success: function(response) {
                    if (response.trim() === "true") {
...
document.getElementById("addAssetCategoryButton").addEventListener("click", function () {
    // Clear the error message
    document.getElementById("errorContainer").textContent = "";

    // Reset the form to its initial state
    document.getElementById("addAssetCategoryForm").reset();
