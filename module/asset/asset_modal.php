...
<form action="./module/asset/addasset_category_run_no.php" method="POST" enctype="multipart/form-data" id="addAssetCategoryForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input list="sectionList" name="department" id="department" class="form-control">
