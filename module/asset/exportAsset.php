...
$columns = ['Id', 'Asset Tag', 'Nfc_code', 'Name', 'Category', 'Status', 'Date Purchase', 'Value', 
            'Price', 'Supplier', 'Branch', 'User', 'Department', 'Contact Number', 'Location', 'Particular', 
            'Document', 'Invoice', 'Start Warranty', 'End Warranty', 'Warranty', 'Code', 'QR Code'];
$colIndex = 1;
...
$sqlAsset = "SELECT * FROM aims_asset";
...
$uploadDirectory = '../../module/asset/export_data/asset/'; // Change this to the desired directory
$filename = 'exportedAsset_data.xlsx'; // Change the filename as needed
