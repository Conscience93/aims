...
<div class="main">
        <form action=".\module\property\addproperty_category_run_no.php" method="POST">
        <div class="card shadow rounded">
            <div class="card-header" style="background:white;">
                <div class="row">
                    <div class="col-6">
                        <h4>Add New Property Category</h4>
                    </div>
                    <div class="col-6">
        ...
        success: function(response){
            ...
            if(response.trim() === "true"){
                ...
                Swal.fire({
                    ...
                    window.location.href = './addpropertyassettag';
                });
            }
        },
...
function autoFillPrefix() {
    ...
    if (categoryInput.value.length >= 2) {
        prefixInput.value = 'P' + categoryInput.value.substring(0, 2).toUpperCase();
    } else if (categoryInput.value.length === 1) {
        prefixInput.value = 'P' + categoryInput.value.toUpperCase() + 'X';
