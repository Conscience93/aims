...
<div class="main">
        <form action=".\module\electronics\addelectronics_category_run_no.php" method="POST">
        <div class="card shadow rounded">
            <div class="card-header" style="background:white;">
                <div class="row">
                    <div class="col-6">
                        <h4>Add New Electronics Category</h4>
                    </div>
                    <div class="col-6">
            ...
            <div class="card-body" style="overflow-y:scroll; overflow-x:hidden;">
                ...
                <div class ="mb-3">
                    <div class = "row">
                        <div class="col-6">
                            <h4>New Electronics Category</h4>
                        </div>
                    </div>
                </div>
                <div class = "row">
        ...
        success: function(response){
            ...
            if(response.trim() === "true"){
                ...
                Swal.fire({
                    ...
                    window.location.href = './addelectronicsassettag';
                });
            }
        },
