...
<head>
    <meta charset="UTF-8">
    <title>Print Department Info</title>
    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <table class="customer-table">
                <tr>
                    <th colspan="3" class="table-header">Department <?php echo $row['id'];?> Details</th>
                </tr>
                <tr>
                    <td colspan="3" class="table-header"><strong>Name: </strong><?php echo $row['display_name'];?></td>
                </tr>
                <tr>
                    <td class="table-header"><strong>Manager: </strong><?php echo $row['pic'];?></td>
                    <td class="table-header"><strong>Phone No: </strong><?php echo $row['contact_number'];?></td>
                    <td class="table-header"><strong>No. of employees: </strong><?php echo $row['noe'];?></td>
                </tr>
            </table>
