...
<head>
    <meta charset="UTF-8">
    <title>Print Location Info</title>
    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <table class="customer-table">
                <tr>
                    <th colspan="3" class="table-header">Location <?php echo $row['id'];?> Details</th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="table-header"><strong>Link: </strong><?php echo $row['google_coordinate'];?></td>
                </tr>
                <tr>
