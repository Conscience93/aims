...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlCheckDuplicate = "SELECT COUNT(*) AS count FROM aims_preset_electronics_brand WHERE display_name = '$display_name'";
    ...
    if ($rowCheckDuplicate['count'] > 0) {
        ...
        $sqlAsset = "INSERT INTO aims_preset_electronics_brand (display_name) VALUES ('$display_name')";
