...
<div class="main">
        <form action=".\module\setting\preset\electronics_brand\add_electronics_brand_action.php" method="POST">
        <div class="card shadow rounded">
            <div class="card-header" style="background:white;">
                <div class="row">
                    <div class="col-6">
                        <h4>Add New Electronic Brand</h4>
                    </div>
                    <div class="col-6">
            ...
            <div class="card-body" style="overflow-y:scroll; overflow-x:hidden;">
                    ...
                    <div class = "row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="display_name">Electronic Brand</label>
        ...
        success: function(response){
            ...
            if(response.trim() === "true"){
                ...
                Swal.fire({
                    ...
                    window.location.href = './add_electronics_brand';
                });
            }
        },
