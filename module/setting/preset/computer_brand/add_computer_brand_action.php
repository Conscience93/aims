...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlCheckDuplicate = "SELECT COUNT(*) AS count FROM aims_preset_devices_computer_brand WHERE display_name = '$display_name'";
    ...
    if ($rowCheckDuplicate['count'] > 0) {
        ...
        // Insert data into the aims_preset_devices_computer_brand table
        $sqlAsset = "INSERT INTO aims_preset_devices_computer_brand (display_name) VALUES ('$display_name')";
