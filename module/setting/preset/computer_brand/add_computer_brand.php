...
<div class="main">
        <form action=".\module\setting\preset\computer_brand\add_computer_brand_action.php" method="POST">
                ...
                <div class = "row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="display_name">Computer/Server Brand</label>
        ...
        success: function(response){
            ...
            if(response.trim() === "true"){
                ...
                Swal.fire({
                    ...
                    window.location.href = './add_computer_brand';
                });
            }
        },
