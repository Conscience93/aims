<?php
    ...
    $sql = mysqli_query($con, "SELECT * FROM aims_commercial_category_run_no WHERE category = '$category'");
    ...
    for ($i = 0; $i < $quantity; $i++) {
        ...
        $sqlDuplicateCheck = "SELECT COUNT(*) as count FROM aims_property_commercial WHERE name = '$name'";
        ...
        $target_directory_document = "../../../include/upload/document/property/commercial/" . $asset_tag . "/";
        ...
        if (isset($_FILES['document']) && $_FILES['document']['error'] === UPLOAD_ERR_OK) {
            ...
            if (copy($document_tmp, $document_destination)) {
                ...
                $document = "include/upload/document/property/commercial/" . $asset_tag . "/" . $document_name;
            }
        }

        // Insert data into the aims_property_commercial table
        $sqlAsset = "INSERT INTO aims_property_commercial 
        ...
        $target_directory_picture = "../../../include/upload/picture/property/commercial/" . $asset_tag . "/";
            ...
            for ($j = 0; $j < $pictureCount; $j++) {
                ...
                if (isset($_FILES['picture']['name'][$j]) && $_FILES['picture']['size'][$j] > 0) {
                    ...
                    if (copy($picture_tmp, $picture_destination)) {
                        ...
                        $picturesForCurrentAsset[] = "include/upload/picture/property/commercial/" . $asset_tag . "/" . $picture_name;
                    }
                }
            }
        }
    ...
    if ($queryAsset) {
        ...
        $update_running_no = mysqli_query($con, "UPDATE aims_commercial_category_run_no SET next_no = '$next_no' WHERE category = '$category'");
        echo "true";
    } else {
        echo "false";
    }
