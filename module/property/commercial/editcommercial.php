...
<div class="main">
    <form action=".\module\property\commercial\editcommercial_action.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <?php 
                                $sql_categories = "SELECT * FROM aims_commercial_category_run_no";
            ...
            success: function(response){
                ...
                if(response.trim()=="true"){
                    ...
                    Swal.fire({
                        ...
                        window.location.href = './editcommercial?id=<?php echo $row["id"];?>';
                    });
                }
            },
            cache: false,
...
function deleteFile(id, fileType) {
    $.ajax({
        url: "./module/property/commercial/deletefile_action.php", // Update the URL to your PHP script
        ...
        success: function(response) {
            ...
            Swal.fire({
                ...
                window.location.href = './editcommercial?id=' + id;
            });
...
function deleteExistingPicture(input, id, view, asset_id) {
    $.ajax({
        url: "./module/property/commercial/deletepicture_action.php",
        type: "POST",
        ...
        success: function(response) {
            Swal.fire({
                ...
                window.location.href = './editcommercial?id=' + asset_id;
            });
        },
        error: function(xhr, status, error) {
            Swal.fire({
