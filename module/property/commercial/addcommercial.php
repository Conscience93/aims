...
<div class="main">
    <form action=".\module\property\commercial\addcommercial_action.php" method="POST" enctype="multipart/form-data">
    <div class="card shadow rounded">
        <div class="card-header" style="background:white;">
            <div class="row">
                <div class="col-6">
                    <h4>Add Commercial Property Information</h4>
                </div>
                <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="dropdown">
                            ...
                            <div id="myDropdown" class="dropdown-content" style="display: none;">
                                <?php 
                                $sql_smartSearchs = "SELECT * FROM aims_property_commercial";
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <datalist id="assetCategoryList">
                                ...
                                <?php 
                                $sql_categories = "SELECT category, display_name FROM aims_commercial_category_run_no";
...
<form action="./module/property/commercial/addcommercial_category_run_no.php" method="POST" enctype="multipart/form-data" id="addAssetCategoryForm">
...
function autoFillPrefix() {
    ...
    if (categoryInput.value.length >= 1) {
        prefixInput.value = 'PC' + categoryInput.value.substring(0, 1).toUpperCase();
    } else if (categoryInput.value.length === 1) {
        prefixInput.value = 'PC' + categoryInput.value.toUpperCase() + 'X';
        // The 'X' or any other letter is added to ensure a minimum length of 3 characters.
    } else {
        prefixInput.value = 'PC';
    }
}
                    ...
                    success: function (response) {
                        ...
                        if (response.trim() == "true") {
                            Swal.fire({
                                ...
                                window.location.href = './addcommercial';
                            });
...
$(document).ready(function () {
    ...
    $('#addAssetCategoryButton').click(function() {
        ...
        if (!/^PC/.test(prefixValue)) {
            // Show an error message for the prefix
            $('#prefixError').text("The prefix must start with the letter 'PC'");
        } else {
            ...
            $.ajax({
                url: './module/property/commercial/addcommercial_category_run_no.php',
                type: 'POST',
                data: formData,
                success: function(response) {
                    if (response.trim() === "true") {
