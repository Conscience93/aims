...
$sql = "SELECT * FROM aims_property_specialized where id ='".$_GET['id']."'";
...
<div class="main">
    <form action=".\module\property\specialized\editspecialized_action.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <?php 
                                $sql_categories = "SELECT * FROM aims_specialized_category_run_no";
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type="number" id="floor" name="floor" value="<?php echo $row['floor'];?>" class="form-control">
                        </div>
                    </div>
                    <!-- built_up_price -->
                    <div class="col-2">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            if (!empty($row['document'])) {
                                ...
                                echo 
                                '<form id="delete-document-form" action="./module/property/specialized/deletefile_action.php" method="POST">
            ...
            success: function(response){
                ...
                if(response.trim()=="true"){
                    ...
                    Swal.fire({
                        ...
                        window.location.href = './editspecialized?id=<?php echo $row["id"];?>';
                    });
                }
            },
            cache: false,
...
function deleteFile(id, fileType) {
    $.ajax({
        url: "./module/property/specialized/deletefile_action.php", // Update the URL to your PHP script
        ...
        success: function(response) {
            ...
            Swal.fire({
                ...
                window.location.href = './editspecialized?id=' + id;
            });
...
function deleteExistingPicture(input, id, view, asset_id) {
    $.ajax({
        url: "./module/property/specialized/deletepicture_action.php",
        type: "POST",
        ...
        success: function(response) {
            Swal.fire({
                ...
                window.location.href = './editspecialized?id=' + asset_id;
            });
        },
        error: function(xhr, status, error) {
            Swal.fire({
