<?php
    ...
    // Get existing link
    $sqlLink = mysqli_query($con, "SELECT * FROM aims_property_specialized WHERE id = '$id'");
    ...
    $sql_asset = "UPDATE aims_property_specialized SET
        name = '$name',
        category = '$category',
        price = '$price',
        floor = '$floor',
    ...
    if (isset($_FILES['picture']) && $_FILES['picture']['name'][0] != "") {
        ...
        for ($i = 0; $i < $pictureCount; $i++) {
            ...
            if (move_uploaded_file($picture_tmp, $picture_destination)) {
                ...
                $picture[] = "include/upload/picture/property/specialized/" . $asset_tag . "/" . $picture_name;
            }
        }
    }
