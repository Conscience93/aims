    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <table class="customer-table">
                ...
                <tr>
                    <td colspan="2" class="table-header"><strong>Built Up Price: </strong>RM<?php echo $row['built_up_price'];?>per sq. ft.</td>
                    <td class="table-header"><strong>Built Up Size: </strong><?php echo $row['built_up_size'];?>sq. ft</td>
                </tr>
                <tr>
                    <td colspan="2" class="table-header"><strong>Land Area Price: </strong>RM<?php echo $row['land_area_price'];?>per sq. ft.</td>
                    <td class="table-header"><strong>Land Area Size: </strong><?php echo $row['land_area_size'];?>sq. ft</td>
                </tr>
                <tr>
                    <td colspan="2" class="table-header"><strong>Remarks: </strong><?php echo $row['remarks'];?></td>
                    <td class="table-header"><strong>Floor </strong><?php echo $row['floor'];?></td>
                </tr>
                <tr>
