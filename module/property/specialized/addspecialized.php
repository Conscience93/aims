...
<div class="main">
    <form action=".\module\property\specialized\addspecialized_action.php" method="POST" enctype="multipart/form-data">
    <div class="card shadow rounded">
        <div class="card-header" style="background:white;">
            <div class="row">
                <div class="col-6">
                    <h4>Add Specialized Property Information</h4>
                </div>
                <div class="col-6">
            ...
            <div class="card-body" style="max-height: 80vh; overflow-y: scroll;">
                    ...
                    <div class="col-6">
                        <div class="dropdown">
                            ...
                            <div id="myDropdown" class="dropdown-content" style="display: none;">
                                <?php 
                                $sql_smartSearchs = "SELECT * FROM aims_property_specialized";
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <datalist id="assetCategoryList">
                                ...
                                <?php 
                                $sql_categories = "SELECT category, display_name FROM aims_specialized_category_run_no";
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="floor">No. of Floor(s)</label>
                            <input type="text" id="floor" name="floor" placeholder="Price in Ringgit"  class="form-control" step="any" min="0">
                        </div>
                    </div>
                    <!-- built_up_price -->
                    <div class="col-2">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="built_up_size">Built Up Size(msq. ft)</label>
...
<form action="./module/property/specialized/addspecialized_category_run_no.php" method="POST" enctype="multipart/form-data" id="addAssetCategoryForm">
...
function autoFillPrefix() {
    ...
    if (categoryInput.value.length >= 1) {
        prefixInput.value = 'PS' + categoryInput.value.substring(0, 1).toUpperCase();
    } else if (categoryInput.value.length === 1) {
        prefixInput.value = 'PS' + categoryInput.value.toUpperCase() + 'X';
        // The 'X' or any other letter is added to ensure a minimum length of 3 characters.
    } else {
        prefixInput.value = 'PS';
    }
}
                    ...
                    success: function (response) {
                        ...
                        if (response.trim() == "true") {
                            Swal.fire({
                                ...
                                window.location.href = './addspecialized';
                            });
...
$(document).ready(function () {
    ...
    $('#addAssetCategoryButton').click(function() {
        ...
        if (!/^PS/.test(prefixValue)) {
            // Show an error message for the prefix
            $('#prefixError').text("The prefix must start with the letter 'PS'");
        } else {
            ...
            $.ajax({
                url: './module/property/specialized/addspecialized_category_run_no.php',
                type: 'POST',
                data: formData,
                success: function(response) {
                    if (response.trim() === "true") {
