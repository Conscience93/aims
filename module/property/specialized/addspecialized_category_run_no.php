...
$duplicateCheckQuery = "SELECT id FROM aims_specialized_category_run_no WHERE display_name = '$display_name' OR category = '$category' OR prefix = '$prefix'";
...
// Insert data into the aims_specialized_category_run_no with fixed next_no and digit_no
$sql = "INSERT INTO aims_specialized_category_run_no 
