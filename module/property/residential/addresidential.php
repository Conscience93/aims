...
<div class="main">
    <form action=".\module\property\residential\addresidential_action.php" method="POST" enctype="multipart/form-data">
    <div class="card shadow rounded">
        <div class="card-header" style="background:white;">
            <div class="row">
                <div class="col-6">
                    <h4>Add Residential Property Information</h4>
                </div>
                <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="dropdown">
                            ...
                            <div id="myDropdown" class="dropdown-content" style="display: none;">
                                <?php 
                                $sql_smartSearchs = "SELECT * FROM aims_property_residential";
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <datalist id="assetCategoryList">
                                ...
                                <?php 
                                $sql_categories = "SELECT category, display_name FROM aims_residential_category_run_no";
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type="number" id="room" name="room" placeholder="" class="form-control">
                        </div>
                    </div>
                    <!-- built_up_price -->
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="built_up_price" name="built_up_price" placeholder="" class="form-control">
                        </div>
                    </div>
                    <!-- built_up_size -->
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="built_up_size" name="built_up_size" placeholder="" class="form-control">
                        </div>
                    </div>
                    <!-- land_area_price  -->
                    <div class="col-2">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type ="text" id="bathroom" name="bathroom" placeholder="" class="form-control">
                        </div>
                    </div>
                    <!-- parking  -->
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type ="text" id="parking" name="parking" placeholder="" class="form-control">
                        </div>
                    </div>
                    <!-- remarks  -->
                    <div class="col-2">
...
<form action="./module/property/residential/addresidential_category_run_no.php" method="POST" enctype="multipart/form-data" id="addAssetCategoryForm">
...
function autoFillPrefix() {
    ...
    if (categoryInput.value.length >= 1) {
        prefixInput.value = 'PR' + categoryInput.value.substring(0, 1).toUpperCase();
    } else if (categoryInput.value.length === 1) {
        prefixInput.value = 'PR' + categoryInput.value.toUpperCase() + 'X';
        // The 'X' or any other letter is added to ensure a minimum length of 3 characters.
    } else {
        prefixInput.value = 'PR';
    }
}
                    ...
                    success: function (response) {
                        ...
                        if (response.trim() == "true") {
                            Swal.fire({
                                ...
                                window.location.href = './addresidential';
                            });
...
$(document).ready(function () {
    ...
    $('#addAssetCategoryButton').click(function() {
        ...
        if (!/^PR/.test(prefixValue)) {
            // Show an error message for the prefix
            $('#prefixError').text("The prefix must start with the letter 'PR'");
        } else {
            ...
            $.ajax({
                url: './module/property/residential/addresidential_category_run_no.php',
                type: 'POST',
                data: formData,
                success: function(response) {
                    if (response.trim() === "true") {
