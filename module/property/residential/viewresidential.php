                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                <a class="btn btn-primary" href='./module/property/residential/print.php?id=<?php echo $row['id']; ?>' target="_blank" title="Print">Print</a>
                        ...
                        <div class="row">
                            <div class="col-7">
                                ...
                                <div class="row">
                                    ...
                                    <label class="col-2" for="room"><b>No. of Room: </b></label>
                                    <span class="col-3" id="room" name="room"><?php echo $row['room']; ?></span>
                                </div>
                                <div class="row">
                                    <label class="col-2" for="bathroom"><b>No. of Bathroom: </b></label>
                                    <span class="col-3" id="bathroom" name="bathroom"><?php echo $row['bathroom']; ?></span>
                                    <label class="col-2" for="parking"><b>No. of parking: </b></label>
                                    <span class="col-3" id="parking" name="parking"><?php echo $row['parking']; ?></span>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <label class="col-2" for="furnish"><b>Furnish: </b></label>
                                    <span class="col-3" id="furnish" name="furnish"><?php echo $row['furnish']; ?></span>
