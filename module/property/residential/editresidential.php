...
<div class="main">
    <form action=".\module\property\residential\editresidential_action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body" style="max-height: 80vh; overflow-y: scroll;">
            ...
            <input id="asset_tag" name="asset_tag" value="<?php echo $row['asset_tag'];?>" hidden>
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <?php 
                                $sql_categories = "SELECT * FROM aims_residential_category_run_no";
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="room">No. of Room</label>
                            <input type="number" id="room" name="room" value="<?php echo $row['room'];?>" class="form-control">
                        </div>
                    </div>
                    <!-- built_up_price -->
                    <div class="col-2">
                        <div class="form-group">
                            <label for="built_up_price">Built Up Price(per sq. ft.)</label>
                            <input type="text" id="built_up_price" name="built_up_price" value="<?php echo $row['built_up_price'];?>" class="form-control">
                        </div>
                    </div>
                    <!-- built_up_size -->
                    <div class="col-2">
                        <div class="form-group">
                            <label for="built_up_size">Built Up Size(sq. ft)</label>
                            <input type="text" id="built_up_size" name="built_up_size" value="<?php echo $row['built_up_size'];?>" class="form-control">
                        </div>
                    </div>
                    <!-- land_area_price  -->
                    <div class="col-2">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <select name="furnish" id="furnish" class="form-control">
                                <option value="" selected>Choose Furnish Type</option>
                                <option value="Fully Furnished"<?php if($row['furnish'] == 'Fully Furnished') {echo 'selected';}?>>Fully Furnished</option>
                                <option value="Non Furnished"<?php if($row['furnish'] == 'Non Furnished') {echo 'selected';}?>>Non Furnished</option>
                                <option value="Partially Furnished"<?php if($row['furnish'] == 'Partially Furnished') {echo 'selected';}?>>Partially Furnished</option>
                            </select>
                        </div>
                    </div>
                    <!-- bathroom  -->
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type ="text" id="bathroom" name="bathroom" value="<?php echo $row['bathroom'];?>" class="form-control">
                        </div>
                    </div>
                    <!-- parking  -->
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input type ="text" id="parking" name="parking" value="<?php echo $row['parking'];?>" class="form-control">
                        </div>
                    </div>
                    <!-- remarks  -->
                    <div class="col-2">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            if (!empty($row['document'])) {
                                ...
                                echo 
                                '<form id="delete-document-form" action="./module/property/residential/deletefile_action.php" method="POST">
            ...
            success: function(response){
                ...
                if(response.trim()=="true"){
                    ...
                    Swal.fire({
                        ...
                        window.location.href = './editresidential?id=<?php echo $row["id"];?>';
                    });
                }
            },
            cache: false,
...
function deleteFile(id, fileType) {
    $.ajax({
        url: "./module/property/residential/deletefile_action.php", // Update the URL to your PHP script
        ...
        success: function(response) {
            ...
            Swal.fire({
                ...
                window.location.href = './editresidential?id=' + id;
            });
...
function deleteExistingPicture(input, id, view, asset_id) {
    $.ajax({
        url: "./module/property/residential/deletepicture_action.php",
        type: "POST",
        ...
        success: function(response) {
            Swal.fire({
                ...
                window.location.href = './editresidential?id=' + asset_id;
            });
        },
        error: function(xhr, status, error) {
            Swal.fire({
